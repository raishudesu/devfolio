...
export const textAnimation = `animate-text bg-gradient-to-r from-[#03fcdb] via-purple-500 to-orange-500 bg-clip-text font-black text-transparent ${montserrat.className}`;

const Hero = () => {
  return (
    <div className="flex flex-col items-center text-center gap-12">
      <div className="flex flex-col gap-2">
        <h1 className={`${textAnimation} font-semibold text-4xl md:text-5xl `}>
          Your Platform to
        </h1>
        <TypeAnimated />
      </div>
